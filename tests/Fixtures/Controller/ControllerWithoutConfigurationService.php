...
class ControllerWithoutConfigurationService extends AbstractController
{
    ...
    {
        return $this->redirectToRoute('jg.batch_entity_import_bundle.test_controller_no_service.import');
    }

    protected function getMatrixSaveActionUrl(): string
    {
        return $this->generateUrl('jg.batch_entity_import_bundle.test_controller_no_service.import_save');
    }
